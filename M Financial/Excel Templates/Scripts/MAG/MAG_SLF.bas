...
sub Main(pmWb as workbook)
	Dim path as string: path = pm.quarterPath & "Data\MAG\" & pm.year & "Q" & pm.quarter & " Magnastar Fees SLF.xlsx"
	...
	Call SQL(workingdir & "MagSun.sqL", pm.server,pm.database,"SLF",QData)
